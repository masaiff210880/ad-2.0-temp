...
// ad Logo
import adlogo from '../../assets/menuIcons/adlogobackground.svg'
//i18n
                                            ...
                                            item.subItems ? (
                                                <li>
                                                    <Link
                                                        ...
                                                        <i className={item.id}><img src ={item.icon} /> </i>
                                                    </Link>
                                                    ...
                                                    <Link
                                                        ...
                                                        className="nav-icon"
                                                        data-bs-toggle="collapse">
                                                        <i className={item.icon}> <img src ={item.icon}/></i>
                                                    </Link>
                                                </>
                                            )

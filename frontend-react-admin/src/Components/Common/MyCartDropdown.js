...
// cart Icon
import cartIcon from '../../assets/menuIcons/cartIcon.svg'
        ...
        <React.Fragment>
            <Dropdown isOpen={isCartDropdown} toggle={toggleCartDropdown} className="topbar-head-dropdown ms-1 header-item">
                <DropdownToggle type="button" tag="button" className="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle">
                    <i className=''> <img src = {cartIcon}/></i>
                    <span
                ...
                <DropdownMenu className="dropdown-menu-xl dropdown-menu-end p-0 dropdown-menu-cart"
                    ...
                    <div className="p-3 border-top-0 border-start-0 border-end-0 border-dashed border">
                        <Row className="align-items-center">
                            ...
                            <div className="col-auto">
                                <span className="btn bg-success text-white"><span className="cartitem-badge"> {cartItem} </span> items</span>
                            </div>
                        </Row>
                    </div>
                    ...
                    <div className="p-3 border-bottom-0 border-start-0 border-end-0 border-dashed border" id="checkout-elem">
                        ...
                        <Link to="/apps-ecommerce-checkout" className="btn btn-success text-center w-10 d-flex justify-content-center ">
                            Click to View
                        </Link>
                    </div>
                </DropdownMenu>

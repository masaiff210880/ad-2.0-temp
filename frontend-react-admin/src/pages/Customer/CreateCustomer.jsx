...
import { Button, Card, CardBody, CardHeader, Col, Container, Form, FormFeedback, Input, Row, TabContent, TabPane } from 'reactstrap';
...
import { getAllCustomer, addNewCustomer as onAddNewCustomer } from '../../slices/ecommerce/thunk';
...
const CreateCustomer = () => {
  ...
  document.title = "Create Customer | American Distributors";
  ...
  const validation = useFormik({
    ...
    onSubmit: (values) => {
      ...
      dispatch(onAddNewCustomer(newCustomer)).then(() => {
  ...
  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          <BreadCrumb title="Customer details" pageTitle="Create Customer" />
          <Row>
            <Col lg={8}>
                            ...
                            <div className="mb-3">
                              ...
                              <div className="input-group mb-3">
                                ...
                                <Input
                                  ...
                                  onBlur={validation.handleBlur}
                                  onChange={validation.handleChange}
                                  invalid={validation.errors.phoneNumber && validation.touched.phoneNumber ? true : false}
                                />
                            ...
                            <div className="mb-3">
                              ...
                              <div className="input-group mb-3">
                                <Input
                                  ...
                                  onBlur={validation.handleBlur}
                                  onChange={validation.handleChange}
                                  invalid={validation.errors.status && validation.touched.status ? true : false}
                                >
                            ...
                            <Col >
                              <div className="">
                                <div className="input-group  mt-4">
                                  <Card>
                                    <h5 className="card-title mb-0">Government issued ID  (Driver’s License, State ID etc)</h5>
                                    <CardBody  >
                                      <UploadComponent {...uploadState} handleChange={handleChange} />
                              ...
                              <Col sm={12}>
                                <div className="mb-3">
                                  ...
                                  <div className="input-group mb-3">
                                    ...
                                    <Input
                                      type="select"
                                      className={`form-control ${validation.errors.storeType && validation.touched.storeType ? 'is-invalid' : ''}`}
                                    ...
                                    {validation.errors.storeType && validation.touched.storeType ? (
                                      <div className="invalid-feedback">{validation.errors.storeType}</div>
                                    ) : null}
                                  </div>
                                </div>
                              </Col>
                                ...
                                <div className="mb-3">
                                  ...
                                  <div className="input-group mb-3">
                                    <Input
                                      ...
                                      onBlur={validation.handleBlur}
                                      onChange={validation.handleChange}
                                      invalid={validation.errors.otpNumber && validation.touched.otpNumber ? true : false}
                                    />
                                    {validation.errors.otpNumber && validation.touched.otpNumber ? (
                                      <FormFeedback type="invalid">{validation.errors.otpNumber}</FormFeedback>
                                    ) : null}
            ...
            <Col lg={4}>
              <div className="card">
                <div className="card-header">
                  ...
                  <h5 className="card-title mb-0"> FEIN License <span style={{ color: "red" }}>*</span>
              ...
              <div className="card mt-4">
                <div className="card-header">
                  <h5 className="card-title mb-0">  Tobacco License
                    <FeatherIcon icon="alert-circle" style={{ width: '12px', height: '12 px', marginLeft: '5px' }} />
                  </h5>
                </div>
                <CardBody>
                  <div className="mb-3" style={{ display: "flex", justifyContent: "center", gap: "10px" }}>
                    <div style={{ width: "111.361px", backgroundColor: "#E9EBEC", height: "111.360px", borderRadius: "5px" }}>
                      <ImageUploader initialImage={uploadedImage2} onImageChange={handleImageChange2} />
                    </div>
                    <div style={{ width: "111.361px", backgroundColor: "#E9EBEC", height: "111.360px", borderRadius: "5px" }}>

                    </div>
                    <div style={{ width: "111.361px", backgroundColor: "#E9EBEC", height: "111.360px", borderRadius: "5px" }}></div>
                    <div style={{ width: "111.361px", backgroundColor: "#E9EBEC", height: "111.360px", borderRadius: "5px" }}></div>
                  </div>
                </CardBody>
              </div>
              ...
              <Card className='mt-4'>
                <div className="card-header">
                  <h5 className="card-title mb-0"> State Tax ID/ Business License</h5>
                </div>
                <CardBody>
                  <div className="mb-3" style={{ display: "flex", justifyContent: "center", gap: "10px" }}>
                    <div style={{ width: "111.361px", backgroundColor: "#E9EBEC", height: "111.360px", borderRadius: "5px" }}>
                      <ImageUploader initialImage={uploadedImage1} onImageChange={handleImageChange1} />
                    </div>
                    <div style={{ width: "111.361px", backgroundColor: "#E9EBEC", height: "111.360px", borderRadius: "5px" }}></div>
                    <div style={{ width: "111.361px", backgroundColor: "#E9EBEC", height: "111.360px", borderRadius: "5px" }}></div>
                    <div style={{ width: "111.361px", backgroundColor: "#E9EBEC", height: "111.360px", borderRadius: "5px" }}></div>

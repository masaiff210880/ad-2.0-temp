                      ...
                      <Nav className="nav-pills nav-justified custom-nav" role="tablist">
                        <NavItem role="presentation">
                          <NavLink
                            ...
                            style={{ backgroundColor: activeTab === 1 ? '#1D9FEC' : '', color: activeTab === 1 ? 'white' : '' }}
                          >
                            <i className="mdi mdi-hand-coin fs-16 p-2 bg-primary-subtle text-primary rounded-circle align-middle me-2"></i>
                            Picking
                          </NavLink>
                        </NavItem>
                        <NavItem role="presentation">
                          <NavLink
                            ...
                            style={{ backgroundColor: activeTab === 2 ? 'orange' : '', color: activeTab === 2 ? 'white' : '' }}
                          >
                            <i className="mdi mdi-cube fs-16 p-2 bg-primary-subtle text-primary rounded-circle align-middle me-2"></i>
                            Packing
                          </NavLink>
                        </NavItem>
                        <NavItem role="presentation">
                          <NavLink
                            ...
                            style={{ backgroundColor: activeTab === 3 ? '#F1C402' : '', color: activeTab === 3 ? 'black' : '' }}
                          >
                        ...
                        <NavItem role="presentation">
                          <NavLink
                            ...
                            style={{ backgroundColor: activeTab === 4 ? '#35BC02' : '', color: activeTab === 4 ? 'white' : '' }}
                          >
...
export default ProgressTabChange;

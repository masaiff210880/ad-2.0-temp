...
const SplitData = ({ rowData, purchaseOrder }) => {
  ...
  const singleSalesData = (vendorSalesId) => {
    setVendorSalesId(vendorSalesId);
  };
    ...
    const singlePurchaseSalesData = createSelector(
      ...
      useEffect(() => {
        if(purchaseSingleSalesData.length>0){}
    ...
    console.log("salse data", rowData,purchaseOrder)
                                                ...
                                                <tr >
                                                    ...
                                                    >
                                                        ...
                                                        <div className={style.cal_div}>
                                                            ...
                                                            <div className={style.cal}>
                                                                <img src={calender} alt="calender" width={'100%'} />
                                                                <h1>{convertDate(item?.createdAt).split(",")[2]}</h1>
                                                            </div>
                                                        </div>
                                                    </td>
                                            ...
                                            <CardBody className="p-4">
                                                <Row className="g-3">
                                                    <Col lg={5} xs={6}>
                                                        ...
                                                        <h5 className="fs-14 mb-0">#VL<span id="invoice-no"> {`Purchase Order# ${rowData?.PoNumber}`}</span></h5>
                                                    </Col>
                                                        ...
                                                        <div className="table-responsive">
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    {convertDate(rowData?.createdAt)}12 JUL 2021
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                            ...
                                            <CardBody className="p-4">
                                                <div className="table-responsive">
                                                    <Table className="table-borderless text-center table-nowrap align-middle mb-0">
                                                        ...
                                                        {rowData?.purchaseItemId?.map((item) => (
                                                            <tr>
                                                                <th scope="row">
                                                                    <div className="avatar-sm bg-light rounded p-1 me-2">
                                                                        <img src={item?.variantId?.featuredImage?.src} alt="" className="img-fluid d-block mx-auto" />
                                                                    </div>
                                                                </th>
                                                    ...
                                                    <Table className=" table-borderless align-middle mb-0 ms-auto" style={{ width: "250px" }}>
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td className="text-end">{`$ ${rowData?.shippingCharges || 0}`}</td>
                                                            </tr>
                                                            <tr>
                                                                <td>Adjustment <small className="text-muted"></small></td>
                                                                <td className="text-end">{`$ ${rowData?.depositeAmount}`}</td>
                                                            </tr>

                                                            <tr className="border-top border-top-dashed fs-15">
                                                                <th scope="row">Total Amount</th>
                                                                <th className="text-end">{`$ ${rowData?.grandTotalAmount || 12290}`}</th>
                                                            </tr>
                                                        </tbody>
                                                    </Table>
                                                </div>

...
// icons
import vanIcon from "../../../assets/vendorIcons/vanIcon.svg";
// style
import style from "../../../styles/products/VendorFlow.module.css";
import { getSingleVendorData } from "../../../slices/ecommerce/thunk";
import { useDispatch, useSelector } from "react-redux";
import { createSelector } from "reselect";
const OverView = ({ id, purchaseOrder, vendoractivityList }) => {
  ...
  const singleData = useSelector(singleVendorData);
  // console.log(singleData)

  useEffect(() => {
    if (id !== undefined) {
      dispatch(getSingleVendorData(id));
    }
  }, [dispatch, id]);
                        ...
                        >
                          <tbody>
                            <tr>
                              ...
                              <td className="text-muted">{`${singleData?.firstName} ${singleData?.lastName}`}</td>
                            </tr>
                            <tr>
                              <th className="ps-0" scope="row">
                                Company Name:{""}
                            ...
                            <tr>
                              ...
                              <td className="text-muted">
                                {formatDate(singleData?.createdAt)}
                              </td>
                            </tr>
                          </tbody>
                        </Table>
                                      ...
                                      >
                                        <div className="d-flex">
                                          ...
                                          <div className="flex-grow-1 ms-3">
                                            <h6 className="fs-14 mb-1">{`${item?.adminId?.firstName} ${item?.adminId?.lastName}`}</h6>

...
export const orderSlice = createSlice({
  ...
  reducers: {
    ...
    set_feinLicense: (state, { payload }) => {
      state.feinLicense = payload.data;
    },
  },
});

export const {get_shipping,set_shipping,set_client_secret,set_feinLicense} = orderSlice.actions;

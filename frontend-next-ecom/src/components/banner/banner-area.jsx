...
import banner_1 from "@assets/img/product/banner/b_1.gif";
import banner_2 from "@assets/img/product/banner/b-2.svg";
  ...
  return (
    <section className="tp-banner-area pb-70">
      <div className="container">
        <div className="row">
          {/* <div className="col-xl-8 col-lg-7" style={{marginLeft:"-10px"}}>
            <BannerItem
              bg={banner_1}
              // title={
              //   <>

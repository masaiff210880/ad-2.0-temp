...
const NewArrivals = () => {
  const { data: products, isError, isLoading } = useGetAllProductsQuery({type:'Smoke',query:'new=true'});
  ...
  // console.log('new arrival poroducts',products)
  return (
    <>
        ...
        <div className="container">
          <div className="row align-items-end">
            <div className="col-xl-5 col-sm-6">
              <div className="tp-section-title-wrapper mb-4">

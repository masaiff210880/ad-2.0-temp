...
// internal
import slider_img_1 from "@assets/img/slider/slider-product-1.png";
import slider_img_2 from "@assets/img/slider/slider-product-2.png";
import slider_img_3 from "@assets/img/slider/slider-product-3.png";
...
import image1 from '@assets/img/banner/image1.svg';
import image4 from '@assets/img/banner/image4.svg';

import image2 from '@assets/img/banner/image2.svg';
  ...
  return (
    <>
      <section className="tp-slider-area p-relative z-index-1">
        ...
        <div className={`${'d-flex justify-content-center'} ${style.banner}`}>
          <div><Image src={image1} alt="image"  className={style.image1Style}/></div>
          <div><Image src={image2} alt="image" className={style.image2Style}/></div>
          <div><Image src={image1} alt="image"  className={style.image1Style}/></div>
        </div>
      </section>
    </>
